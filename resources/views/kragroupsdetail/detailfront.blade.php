...
<div class="uper">
              ...
              <h3 class="heading_b uk-margin-bottom">KRA GROUP DETAILS</h3>
            ...
            <div class="md-card uk-margin-medium-bottom">
                ...
                <a href="{{URL('show3')}}" class="btn btn-sm btn-success"  style="margin-left:40%;margin-bottom:3%;">ADD GROUP</a>                    
                    ...
                    <div class="dt_colVis_buttons"></div>
                        ...
                        <table id="dt_tableExport" class="uk-table uk-table-nowrap table_check" >
                            ...
                            <th class="uk-width-1-10 uk-text-center small_col"><input type="checkbox" data-md-icheck class="check_all"></th>
                               ...
                               <th class="uk-width-2-10 uk-text-center">KRA  Name</th>
                               <th class="uk-width-3-10 uk-text-center">Percentage</th>
                            ...
                            @foreach($kras as $kra)
                                <tr>
                                    ...
                                    <td class="uk-text-center">{{$kra->percentage}}</td>
